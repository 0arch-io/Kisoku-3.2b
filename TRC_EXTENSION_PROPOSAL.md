# TRC Extension Proposal: OpenMind 3.2B

**Project**: OpenMind 3.2B - Maximum Efficiency LLM Training on Apple's DCLM Dataset
...
### Why Fund OpenMind 3.2B vs Other Projects?

| Criteria | OpenMind 3.2B | Typical Project |
|----------|---------------|-----------------|
